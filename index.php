...
// Fetch top featured products from DB via PDO Prepared Statement
$pdo = getDBConnection();
$stmt = $pdo->prepare("SELECT id, name, description, price, stock, category, image_url FROM products ORDER BY id ASC LIMIT 3");
$stmt->execute();
