...
<head>
    ...
    <title><?= $pageTitle ?? 'SecureCart — Secure Online Shopping' ?></title>
    <!-- Bootstrap 5 CSS -->
                ...
                <?php if (is_logged_in()): ?>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                            <li><span class="dropdown-item-text text-muted small"><?= $currentUser['email'] ?> (<?= ucfirst($currentUser['role']) ?>)</span></li>
...
<div class="container mt-3">
    <?php if ($flash): ?>
        <div class="alert alert-custom-<?= $flash['type'] ?> alert-dismissible fade show d-flex align-items-center justify-content-between" role="alert">
            <div>
                <strong>Security Alert:</strong> <?= $flash['message'] ?>
            </div>
