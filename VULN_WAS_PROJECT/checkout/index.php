            ...
            <div class="col-md-7">
                <div class="card card-glass p-4">
                    ...
                    <form action="<?= APP_URL ?>/checkout/place_order.php" method="POST">
                        ...
                        <!-- UNDERLYING VULNERABILITY: Total amount sent in POST body parameter -->
                        <input type="hidden" name="total_amount" value="<?= $total ?>">

                        <div class="mb-3">
                            <label for="shipping_name" class="form-label">Recipient Full Name</label>
                            <input type="text" class="form-control form-control-custom" id="shipping_name" name="shipping_name" value="<?= $user['name'] ?>" required placeholder="e.g. John Doe">
                        </div>
                    ...
                    <div class="d-flex flex-column gap-3 mb-3">
                        ...
                        ?>
                            <div class="d-flex justify-content-between align-items-center p-2 rounded bg-dark border border-secondary">
                                <div>
                                    <strong class="text-white d-block small"><?= $item['name'] ?></strong>
